export const projectList = {
  debt: {
    projectTitle: 'Debt Amortization',
    urls: [
      'https://www.debt-strategy.com/'
    ],
    description: 'I designed this website as an easy way to see a loan or credit card breakdown over time. By entering some basic information, such as the loan amount, interest rate, and loan period, ' +
                  'users can see a row by row breakdown of payments, interest, and even cumulative interest. When viewing from a non-mobile device, you can see an interactive graph or even download a ' +
                  'CSV copy of the generated table.'
  },
  dnd: {
